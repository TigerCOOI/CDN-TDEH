...
!function(){
    ...
    ready=function(c){
        ...
        for(var a=0,c=b.length;c>a;a++)b[a].apply(document);b=[]
    },e=function()
...
bszTag={
    bszs:["site_pv","page_pv","site_uv"],texts:function(a){
        this.bszs.map(function(b){
            var c=document.getElementById("jishu_value_"+b);c&&(c.innerHTML=a[b])
        })
    },hides:function(){
        this.bszs.map(function(a){
            var b=document.getElementById("jishu_container_"+a);b&&(b.style.display="none")
        })
    },shows:function(){
        this.bszs.map(function(a){
            var b=document.getElementById("jishu_container_"+a);b&&(b.style.display="inline")
        })
    }
};